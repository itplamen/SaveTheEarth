...
exports.Spec = require('./Helper.Tests');
...
require.register("reporters/Helper.Tests.js", function(module, exports, require){
...
}); // module: reporters/Helper.Tests.js
...
function filterLeaks(ok, globals) {
  return filter(globals, function(key){
    ...
    // in firefox
    // if runner runs in an iframe, this iframe's window.getInterface method not initializeAllStubs at first
...
function highlight(js) {
  return js
    ...
    .replace(/\bnew *(\w+)/gm, '<span class="keyword">new</span> <span class="initializeAllStubs">$1</span>')
